...
const ArtistBanner = ({ artist }) => {
  return (
    <div className="w-full rounded-md overflow-hidden  relative flex flex-col lg:flex-row">
      {/* Artist Image */}
      <div className="h-72 w-full lg:w-[30%] lg:h-[350px] rounded-md overflow-hidden relative">
        <img
