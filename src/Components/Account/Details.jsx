      ...
      <div className="w-full min-h-[200px] mt-2 flex rounded-md p-5 flex-col space-y-7 bg-[#101010] border-[1px] border-[#1a1a1a]">
        <div>
          ...
          <div className="flex items-center">
            ...
            >
              <FontAwesomeIcon
                icon={faEdit}
                className="p-3 bg-pink-primary text-white rounded-md"
              />
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <input
            type="text"
            disabled
            value={formatToDDMonYYYY(joined)}
            className="bg-[#181818] w-full rounded-md py-3 px-4 text-base text-[#636363] outline-none border-2 border-[#1f1f1f]"
          />
        </div>
      </div>
...
const EditName = ({ name }) => {
  ...
  const { user, setUser, updateName } = useUser();
    ...
    >
      ...
      <div>
        ...
        <span
          ...
          className="py-2 px-4 text-sm bg-pink-primary text-white rounded-md cursor-pointer"
        >
          Update
        </span>
      </div>
